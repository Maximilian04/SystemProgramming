...
"        <tr><td port=\"" #name "\" colspan=\"2\"><FONT COLOR=\"" COLORS_SETTINGS_LOGICPOINTER_TEXTCOLOR \
"\">" __VA_OPT__("[") "%u" __VA_OPT__("]") "</FONT></td></tr>\n"
...
"    element_%S -> element_tail [style = invis; weight = " WEIGTH_ORDER_ARROWS ";];\n"
"    element_%S -> element_head [style = invis; weight = " WEIGTH_ORDER_ARROWS ";];\n"
"\n"
"    { rank=same; element_%S; element_%p; }\n"
"\n"
"    element_%S:s -> element_%p:head:n [color = \"" COLORS_SETTINGS_GRAHARROW_FORWARD "\"; weigth = " WEIGTH_EGGS_ARROWS ";];\n"
;
