...
#define ELEM_ARROW(nameSrc, nameDst, color) \
"    element_%p -> element_%p [color = \"" #color "\"; constraint = false;];\n"
...
"    { rank=same; element_head; element_%p; }\n"
"\n"
"    element_tail -> element_%p [color = \"coral\"; weigth = 200;];\n"
"    element_head -> element_%p [color = \"indigo\"; weigth = 200;];\n"
;
...
"    { rank=same; element_%S; element_%p; }\n"
"\n"
"    element_%S -> element_%p [color = \"coral\"; weigth = 200;];\n"
;
